...
//
// Returns:
// - A slice of int8 digits representing the product of the two n integers.
//
// Notes:
...
//
// Time Complexity: O(n1 * n2), where n1 and n2 are the lengths of the n slices sn1 and sn2,
